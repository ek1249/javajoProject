...
<table border="1" width="50%" cellpadding="0" cellspacing="0" align="center">
	...
	<tr align="center" bordercolor="white">
		<td>첨부파일 : </td>
		<td><img src="img/${b.board_fname }" width="300" height="200"></td>
	</tr>
	</m:if>
	<tr align="center" bordercolor="white">
		<td colspan="2">내용 : </td>
	...
	<tr align="center" bordercolor="white">
		<td colspan="2" width="400" height="200">${b.board_content }</td>
	</tr>
</table>
<m:if test="${n2==1 }">
<table align="right">
		<tr>
			<td><a href="boardupdate.com?no=${b.board_number }"><input type="button" value="수정"></a></td>
			<td><a href="boarddelete.com?no=${b.board_number }"><input type="button" value="삭제"></a></td>
		</tr>
</table>
</m:if>
</body>
