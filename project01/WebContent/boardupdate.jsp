...
<hr>
<form action="boardupdateok.com" method="post" enctype="multipart/form-data">
<input type="hidden" name="id" value="${id }">
<input type="hidden" name="no" value="${b.board_number }">
<input type="hidden" name="oldfname" value="${b.board_fname }">
		<table border="1" width="100%" cellpadding="0" cellspacing="0" align="center">
			<tr bordercolor="white">
				<td>제목 : </td>
				<td><input type="text" name="title" value="${b.board_title }"></td>
			</tr>	
			<tr bordercolor="white">
				<td>첨부파일 : </td>
				<td colspan="2">
			...
			<tr bordercolor="white">
				<td>내용</td>
				<td>
					<textarea rows="20" cols="30" name="content">${b.board_content }</textarea>
				</td>
			</tr>
		</table>
