...
<hr>
<h2>수정페이지</h2>
<form action="eventUpdateOk.com" method="post" enctype="multipart/form-data">
		<input type="hidden" name="no" value="${e.event_no }">
		이벤트명 : <input type="text" name="title" value="${e.title }"><br> 
		이벤트 이미지:<input type="file" name="fname" value="${e.fname }"><br>
		<img src ="event/${e.fname }">
		이벤트 내용 : <br>
		<textarea rows="10" cols="60" name="content">${e.content }</textarea>
