...
<hr>
<form action="movietheaterupdateok.com" method="post">
	<input type="hidden" name="no" value="${mt.movietheater_number }">
	<table border="1" cellpadding="0" cellspacing="0" width="75%">
		<tr bordercolor="white">
			<td>영화관 이름 : </td>
			<td><input type="text" name="name" value="${mt.movietheater_name }"></td>
		</tr>
		<tr bordercolor="white">
			<td>영화관 위치 : </td>
			<td><input type="text" name="loc" value="${mt.movietheater_loc }"></td>
		</tr>
		<tr bordercolor="white">
			<td>이벤트 : </td>
			<td><input type="text" name="event" value="${mt.movietheater_event }"></td>
		</tr>
	</table>
	<hr>
	<table align="right">
