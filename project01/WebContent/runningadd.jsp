			...
			<table border="1">
				...
				<m:forEach var="mtl" items="${mtlist }">
					<tr>
						...
						<td>
							<a href="runningadd.com?mtno=${mtl.movietheater_number }">
		...
		<td>
			<table border="1">
				...
				<m:forEach var="tl" items="${tlist }">
					<tr>
						<td>${tl.theater_number }</td>
					</tr>
				</m:forEach>
			</table>
		</td>
		<td>
			<form action="runningaddok.com" method="post">
				<table border="1">
					<tr>
						<td>상영관 번호</td>
					...
					<tr>
						<td>영화 번호</td>
						<td><input type="text" name="mno2"></td>
					</tr>
					<tr>
						<td>상영 날짜</td>
					...
					<tr>
						<td>상영 시작 시간</td>
						<td><input type="text" name="rs">분</td>
					</tr>
					<tr align="center">
