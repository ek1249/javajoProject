...
<table align="center">
	<tr>
			...
			<table border="1">
				...
				<m:forEach var="mtl" items="${mtlist }">
					<tr>
						...
						<td>
							<a href="runningdelete.com?mtno=${mtl.movietheater_number }">
		...
		<td>
			<table border="1">
				...
				<m:forEach var="tl" items="${tlist }">
					<tr>
						<td>
							<a href="runningdelete.com?tno=${tl.theater_number }">
								${tl.theater_number }
							</a>
						</td>
					</tr>
		...
		<td>
			<table border="1">
				...
				<m:forEach var="rl" items="${rlist }">
					<tr>
						<td>${rl.running_number }</td>
						<td>
							<a href="runningdelete.com?rno=${rl.running_number }">
								${rl.running_date }
							</a>
						</td>
		...
		<td>
			<form action="runningdeleteok.com" method="post">
				<table>
					<tr>
						<td>상영 번호</td>
						<td><input type="text" name="rno2" value="${r.running_number }" readonly="readonly"></td>
					</tr>
					<tr>
						<td>상영관 번호</td>
						<td><input type="text" name="tno2" value="${r.theater_number }"></td>
					</tr>
					<tr>
						<td>영화 번호</td>
						<td><input type="text" name="mno2" value="${r.movie_number }"></td>
					</tr>
					<tr>
						<td>상영 날짜</td>
						<td><input type="text" name="rd" value="${r.running_date }"></td>
					</tr>
					<tr>
						<td>상영 시작 시간</td>
						<td><input type="text" name="rs" value="${r.running_start }"></td>
					</tr>
					<tr>
