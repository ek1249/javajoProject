...
<table align="center">
	<tr>
			...
			<table border="1">
				...
				<m:forEach var="mtl" items="${mtlist }">
					<tr>
						...
						<td>
							<a href="runningupdate.com?mtno=${mtl.movietheater_number }">
		...
		<td>
			<table border="1">
				...
				<m:forEach var="tl" items="${tlist }">
					<tr>
						<td>
							<a href="runningupdate.com?tno=${tl.theater_number }">
								${tl.theater_number }
							</a>
						</td>
					</tr>
			...
			<table border="1">
				...
				<m:forEach var="rl" items="${rlist }">
					<tr>
						...
						<td>
							<a href="runningupdate.com?rno=${rl.running_number }">
								${rl.running_date }
							</a>
						</td>
		...
		<td>
			<form action="runningupdateok.com" method="post">
				<table>
					<tr>
						<td>상영 번호</td>
